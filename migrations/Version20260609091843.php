 ...
 */
final class Version20260609091843 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE costumer_tags (tags_id INT NOT NULL, costumer_id INT NOT NULL, INDEX IDX_E4ECFD238D7B4FB4 (tags_id), INDEX IDX_E4ECFD2360B71152 (costumer_id), PRIMARY KEY (tags_id, costumer_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
